...
exports.matchMakeToRoom = void 0;
...
*/
function matchMakeToRoom(room = "lobby_room", progress = "0,0") {
    return __awaiter(this, void 0, void 0, function* () {
        return yield colyseus_1.matchMaker.joinOrCreate(room, { progress });
    });
}
exports.matchMakeToRoom = matchMakeToRoom;
